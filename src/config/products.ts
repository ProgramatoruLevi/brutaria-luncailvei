...
export const products: Product[] = [
  ...
  // === PATISERIE ===
  {
    ...
    category: 'patiserie',
    image: 'https://images.unsplash.com/photo-1530610476181-d83430b64dcd?w=800&h=600&fit=crop',
    tags: ['bestseller'],
    featured: true,
    seasonal: false,
  },
  {
    ...
    category: 'patiserie',
    image: 'https://images.unsplash.com/photo-1623334044303-241021148842?w=800&h=600&fit=crop',
    tags: ['bestseller'],
    featured: false,
    seasonal: false,
  },
  {
    ...
    category: 'patiserie',
    image: 'https://images.unsplash.com/photo-1619221882220-947b3d3c8861?w=800&h=600&fit=crop',
    tags: ['traditional'],
    featured: false,
    seasonal: false,
  },
